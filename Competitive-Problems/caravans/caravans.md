...
For each tFor each test case, output a single line containing the number of cars which were moving at their maximum speed on the segment.

est case, print a single line containing one integer — the minimum required number of moves.
